...
function getUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!todo) {
                (0, handleResponse_1.sendErrorResponse)(res, { statusCode: 404, message: 'User not found' });
            }
            else {
...
function editUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const user = yield users_models_1.User.findByIdAndUpdate(id, updates, { new: true, runValidators: true });
            if (!user) {
                (0, handleResponse_1.sendErrorResponse)(res, { statusCode: 404, message: 'user not found' });
            }
            else {
